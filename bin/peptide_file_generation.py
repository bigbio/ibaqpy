...
def peptide_file_generation(msstats: str, sdrf: str, compress: bool, min_aa: int, output: str) -> None:
    """
  ...
  """
    ...
    msstats_df = msstats_df.groupby(PROTEIN_NAME).filter(lambda x: len(set(x[PEPTIDE_SEQUENCE])) >= 2)
